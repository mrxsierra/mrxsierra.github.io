...
[![Tests](https://img.shields.io/badge/Tests-38%20Passed-brightgreen?style=flat&logo=pytest)](tests/)
...
| `make test` | Run full 38-test automated pytest verification suite |
...
- **Verification Engine**: 38 automated test cases via `pytest`, `beautifulsoup4`, `ruff`, and `mypy` (`scripts/verify.py`).
- **Governance & CI/CD**:
