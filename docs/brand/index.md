---
description: Official Brand Identity, Vector Marks, Content Creation Suite, and Press Kit for Sunil Sharma (mrxsierra).
---
...
<div class="card-grid-2" style="margin: 24px 0;">
  ...
  <div class="clean-card">
    ...
    <a href="../assets/brand/monogram-dark.svg" download class="card-footer-link">
  ...
  <div class="clean-card">
    ...
    <a href="../assets/brand/monogram-light.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
  ...
  <div class="clean-card">
    ...
    <a href="../assets/brand/logo-horizontal.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
  ...
  <div class="clean-card">
    ...
    <a href="../assets/brand/monogram-transparent.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
...
Broadcast-ready graphics for YouTube tutorials, coding screencasts, webinars, and live streams:

| Asset | Format | Resolution | Description | Download |
| :--- | :--- | :--- | :--- | :--- |
| **YouTube Watermark** | PNG (Transparent) | 150×150 | Official bottom-right in-video branding watermark. | [Download PNG](../assets/brand/video/watermark-150x150.png) |
| **Broadcast Lower Third** | SVG (Transparent) | 1920×1080 | Speaker overlay for video talks and webinars. | [Download SVG](../assets/brand/video/lower-third.svg) |
...
<div class="card-grid-2" style="margin: 20px 0;">
  ...
  <div class="clean-card">
    <div class="project-card-header">
      <span class="project-category-badge">GitHub Profile</span>
    </div>
    <h3 class="project-card-title">GitHub Header Banner</h3>
    <p class="project-card-desc">1280×640px hero banner for GitHub profile READMEs and repository organization headers.</p>
    <a href="../assets/brand/banners/github-banner.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
  ...
  <div class="clean-card">
    <div class="project-card-header">
      <span class="project-category-badge">LinkedIn Cover</span>
    </div>
    <h3 class="project-card-title">LinkedIn Profile Banner</h3>
    <p class="project-card-desc">1584×396px cover banner optimized for LinkedIn avatar clearance and desktop/mobile responsiveness.</p>
    <a href="../assets/brand/banners/linkedin-banner.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
  ...
  <div class="clean-card">
    <div class="project-card-header">
      <span class="project-category-badge">X (Twitter) Header</span>
    </div>
    <h3 class="project-card-title">X Profile Header</h3>
    <p class="project-card-desc">1500×500px minimalist header with engineering disciplines and website domain.</p>
    <a href="../assets/brand/banners/x-twitter-banner.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
  ...
  <div class="clean-card">
    <div class="project-card-header">
      <span class="project-category-badge">YouTube Channel</span>
    </div>
    <h3 class="project-card-title">YouTube Channel Banner</h3>
    <p class="project-card-desc">2560×1440px master banner with centered multi-device safe zone.</p>
    <a href="../assets/brand/banners/youtube-banner.svg" download class="card-footer-link">
      <i class="fas fa-download"></i> Download SVG
    </a>
  </div>
...
| :--- | :--- | :--- | :--- |
| `--color-obsidian` | `#08090D` | `oklch(0.12 0.01 260)` | Primary Canvas &amp; Background |
| `--color-accent` | `#6366F1` | `oklch(0.58 0.23 277)` | Electric Indigo (Primary Accent) |
| `--color-accent-light`| `#818CF8` | `oklch(0.68 0.19 277)` | Highlight &amp; Focus Indicators |
| `--color-surface` | `#18181B` | `oklch(0.21 0.01 260)` | Card Surface &amp; Elevated UI |
