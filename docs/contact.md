---
description: Contact Sunil Sharma (mrxsierra) for engineering collaborations, AI systems architecture, and consulting inquiries.
---

# Contact &amp; Developer Network

<div class="page-intro">
  <h2 class="page-intro-title">Initiate Collaboration</h2>
  ...
  <div style="margin-top: 16px; display: flex; gap: 10px; flex-wrap: wrap;">
    ...
    <a href="https://www.linkedin.com/in/sunilsharma97/" target="_blank" rel="noopener" class="btn btn-secondary">
...
<div class="workspace-grid" style="margin: 20px 0;">
  ...
  <div class="workspace-panel">
    <h3><i class="fas fa-code-branch"></i> Engineering &amp; Code</h3>
    
    <div class="profile-category-block">
      <span class="profile-category-label">Code Repositories &amp; Artifacts</span>
  ...
  <div class="workspace-panel">
    <h3><i class="fas fa-users"></i> Network &amp; Community</h3>
    
    <div class="profile-category-block">
      <span class="profile-category-label">Professional &amp; Publications</span>
      <div class="social-chips-grid">
