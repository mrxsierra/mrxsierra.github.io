---
description: Official Press Kit, Media Resources, Biography Sheets, and Brand Assets for Sunil Sharma (mrxsierra).
---
...
<div class="card-grid-2">
  ...
  <div class="clean-card">
    ...
    <p class="profile-intro-subtitle">
      ...
      <strong>Location:</strong> India (UTC+05:30)
    </p>
  </div>
...
Use these pre-approved biography variations for conference programs, podcast introductions, guest publication bylines, and media coverage:
...
=== "Technical Abstract & Architecture Philosophy"
    ```text
...
<div class="capability-grid">
  ...
  <div class="capability-card">
    ...
    <div class="capability-tags">
      <span class="capability-tag">RDBMS Architecture</span>
      <span class="capability-tag">Schema Migrations</span>
      <span class="capability-tag">SQL Dialects</span>
    </div>
  </div>
  ...
  <div class="capability-card">
    ...
    <div class="capability-tags">
      <span class="capability-tag">Tabular ML</span>
      <span class="capability-tag">SHAP Explainability</span>
      <span class="capability-tag">XGBoost / LightGBM</span>
    </div>
  </div>
  ...
  <div class="capability-card">
    ...
    <div class="capability-tags">
      ...
      <span class="capability-tag">MCP Tools</span>
      <span class="capability-tag">Verification Harnesses</span>
    </div>
  </div>
...
<div class="card-grid-2">
  ...
  <div class="clean-card">
    ...
    <a href="../assets/brand/video/watermark-150x150.png" download class="card-footer-link">
